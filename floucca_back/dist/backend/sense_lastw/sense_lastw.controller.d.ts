...
export declare class SenseLastwController {
    ...
    getAllSenseLastw(): Promise<import("./interface/getAllSense_lastw.interface").GetAllSenseLastw[]>;
    getSenseLastwById(sense_lastw_id: idDTO): Promise<import("./interface/getAllSense_lastw.interface").GetAllSenseLastw>;
